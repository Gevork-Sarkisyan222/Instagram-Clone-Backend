...
export class UserController {
  ...
  @Delete('/delete/subscriber/user/:id')
  async deleteSubscriberUser(@Param('id') id: string, @Request() req: any) {
    await this.userService.deleteSubscriberUser(id, req)

    return { message: 'Subscriber user has been deleted' };
  }


  @Patch('/return/subscriber/user/:id')
  async returnSubscriberUser(@Param('id') id: string, @Request() req: any) {
    await this.userService.returnSubscriberUser(id, req)

    return { message: 'Subscriber user has been returned' };
  }
}
